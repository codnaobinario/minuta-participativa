    ...
    <div class="pure-g-r">
        ...
        <div class="pure-u-1 menubar">
            ...
            <ul class="secondary">
                ...
                <?php else : ?>
                <li><a class="register-button" href="<?php echo WP_SITEURL ?>/wp-login.php?action=register">Cadastre-se</a></li>
                <li><a class="login-button" href="<?php echo WP_SITEURL ?>/wp-login.php">Login</a></li>
                <?php endif; ?>
            </ul>
        </div>
